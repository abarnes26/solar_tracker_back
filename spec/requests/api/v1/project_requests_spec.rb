  ...
  context "HTTP POST" do
    it "creates a new project" do
      VCR.use_cassette("create_a_new_project") do
        ...
        post "/api/v1/projects?project[street]=8279%20Iris%20St&project[city]=Arvada&project[state]=CO&project[zipcode]=80005&project[customer%5Fname]=Joseph&project[size%5FkW]=4&project[branch%5Fid]=#{branch.id}&vehicle[:id]=#{vehicle.id}"
