...
#
#       post "/api/v1/projects?project[street]=Ambling%20Way&project[city]=Arvada&project[state]=CO&project[zipcode]=80003&project[customer%5Fname]=Joseph&project[size%5FkW]=4&project[branch%5Fid]=#{branch.id}vehicle[id]=#{vehicle.id}"
#
#       expect(response).to be_success
